    ...
    return (
        <div className=''>
            <div className="flex gap-3 items-start mb-6">
                ...
                <Link className='bg-[#08311F] rounded-full' to={`/profile/${userId}`}>
                <img
                    src={userAvatar}
                ...
                <div className="flex-1 bg-[#F3F7F5] p-4 rounded-xl shadow-sm max-w-[35rem]">
                    <div className="flex justify-between items-center mb-1">
                        <Link  to={`/profile/${userId}`} className="font-semibold text-[#0B3D26] break-words max-w-[10rem] md:max-w-full">{userName}</Link>
